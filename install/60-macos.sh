...
sudo scutil --set ComputerName "jeroennoten"
sudo scutil --set HostName "jeroennoten"
sudo scutil --set LocalHostName "jeroennoten"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "jeroennoten"
...
# Trackpad: enable three finder drag
